...
public class Utils {
    ...
    // Basically here we go from coefficient on position start, until coefficient on position end - 1, and multiply it with all the coefficients from polynomial 2
    ...
    public static Polynomial KaratsubaSequential(Polynomial p1, Polynomial p2){
        ...
        // compute the final result= z3* x^2m + (z2-z3-z1)* x^m + z1
        // z3 must be shifted by 2m (z3-> represents the result of multiplying the high parts

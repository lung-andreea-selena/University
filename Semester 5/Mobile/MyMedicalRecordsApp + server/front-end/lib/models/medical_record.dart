class MedicalRecord {
  ...
  // Serialize MedicalRecord into a JSON format
  ...
  // Deserialize JSON format into a MedicalRecord instance
  factory MedicalRecord.fromJson(Map<String, dynamic> json) {
    return MedicalRecord(
      id: json['id'],
      title: json['title'],
      type: json['type'],
      moneySpent: json['moneySpent'].toDouble(), // Ensure moneySpent is cast to double if coming from JSON
      date: json['date'],
